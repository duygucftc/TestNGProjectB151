...
public class Driver {
    private Driver(){
        /*
        Driver class'indan obje olusturmanin onune gecebilmek icin default constructor'i private yaparak
        bunu engellemis oluruz. Bu kaliba da Singleton Pattern denir.
         */
    }
    /*
    POM(Page Object Model)
       Test senaryolarinin daha az kod ile yazilmasina ve bakiminin daha kolay yapilmasina olanak saglayan
       yazilim test yontemidir.TestNG ve Cucumber frameworklerinde POM kalibi kullanilir.
     */
...
driver'i aynı sayfada return et
    */
     ...
     /*
     .properties dosyasina key olarak browser ve degerini asagida olusturdugumuz switch case'lerden birini seceriz
